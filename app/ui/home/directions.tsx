...
export default function Directions({
  ...
  React.useEffect(() => {
    ...
    const clickIds: google.maps.MapsEventListener[] = [];
      ...
      >
            ...
            href={
              ...
              createQueryString([
                ...
                },
                {
                  name: 'sl',
                  value:
                    leg.start_location.lat().toString() +
                    ',' +
                    leg.start_location.lng().toString(),
                },
                {
                  name: 'r',
        ...
        <div className="grow">
          ...
          <h1 className="text-base text-center">
            {leg.duration_in_traffic?.text} | {leg.distance?.text}
          </h1>
        </div>
      </div>
    </>
