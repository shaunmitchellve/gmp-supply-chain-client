          ...
          <div className="flex-col flex self-center p-10 sm:max-w-5xl xl:max-w-2xl z-10">
            <div className="self-start hidden lg:flex flex-col text-white">
              <h1 className="mb-3 font-bold text-5xl">
                Welcome to Cymbol Shops{' '}
                <span className="text-red-600">Track-It</span>
              </h1>
              <p className="pr-3">
                Track-It provides Cymbol Shops with real-time visibility into
          ...
          <div className="flex justify-center self-center z-10">
            <div className="p-8 xl:p-12 bg-white mx-auto rounded-2xl">
              ...
              <div className="pt-5 text-center text-gray-400 text-xs">
                <span>Copyright © 2023 Cymbol Shops</span>
              </div>
            </div>
          </div>
        </div>
