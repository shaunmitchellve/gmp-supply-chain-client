...
export default function ErrorPage({params, searchParams}:{params: { slug: string}; searchParams: { [key: string]:string | string[] | undefined }}) {
    let errorMessage:string = "An error has occured with your access.";

    if(searchParams.error){
        switch (searchParams.error) {
            case "accessdenied":
                errorMessage = "Access Deined: You have stumbled into a restricted area."
        }
    }
    return (
